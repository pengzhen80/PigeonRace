...
function onChanged(collection, added, removed, changed) {
    ...
    console.log(msg);
    // var msg_removed = 'remove ids';
    // for (var i = 0; i < removed.length; i++) {
    //     msg_removed += '\n' + removed[i].id;
    // }
    // console.log(msg_removed);

    // var msg_changed = 'changed ids';
...
function showData(flightData) {
    ...
    var sublines = tmp_flightData.shift();
    //remove near points
